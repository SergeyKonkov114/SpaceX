...
class FifthCustomCell: UITableViewCell {
    ...
    private lazy var titleLabel: UILabel = {
        let label = configureLabel(with: "ВТОРАЯ СТУПЕНЬ", fontName: "HelveticaNeue-Bold")
    ...
    var viewModel: TableViewCellViewModelType? {
        willSet(viewModel) {
            guard let viewModel = viewModel as? TableViewFifthCellViewModel else { return }
